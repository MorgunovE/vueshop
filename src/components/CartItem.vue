<template>
  <li class="cart__item product">
    <div class="product__pic">
      <img :src="item.product.image" width="120" height="120" :srcset="item.product.image.split('.')+'@2x.jpg 2x'" :alt="item.product.title">
    </div>
...
export default {
  ...
  methods: {
    ...mapMutations({deleteProduct:'deleteCartProduct',addProduct:'addAmountToCart',reduceProduct:'reduceAmountToCart'}),
  },
}
</script>
